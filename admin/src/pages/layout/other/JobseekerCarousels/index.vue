...
import { getJobseekerCarousels, updateCarousel, deleteCarousel,addCarousel } from '@/api/other/index.js';
...
const getCarousels = async () => {
  const res = await getJobseekerCarousels();
  if (res.code === 200) {
